...
<section class="pt-32 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-gray-50">
    <div class="max-w-7xl mx-auto text-center">
        <h1 class="text-5xl lg:text-6xl font-bold text-gray-900 mb-6">Artikel</h1>
    ...
    <div class="max-w-7xl mx-auto">
        @if($articles->isEmpty())
            <div class="text-center py-20">
                ...
                <h3 class="mt-6 text-2xl font-semibold text-gray-900">Belum ada artikel</h3>
                <p class="mt-2 text-gray-600">Periksa kembali untuk konten baru!</p>
            </div>
        @else
